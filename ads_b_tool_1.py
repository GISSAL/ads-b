...
try:
    ...
    print("Identical aircraft waypoints removed.")
    arcpy.AddMessage("Identical aircraft waypoints removed.")
    ...
    print("Single waypoint records and unused attribute fields removed.")
    arcpy.AddMessage("Single waypoint records and unused attribute fields removed.")
